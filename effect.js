...
function parallaxScroll(){
 ...
 $('.layer-4').css('top', (0 - (scrolled * 1)) + 'px');
 $('.layer-5').css('top', (0 - (scrolled * 1.25)) + 'px');
 $('.layer-6').css('top', (0 - (scrolled * 1.5)) + 'px');
 $('.layer-7').css('top', (0 - (scrolled * .5)) + 'px');
 $('.layer-8').css('top', (0 - (scrolled * .75)) + 'px');
 $('.layer-9').css('top', (0 - (scrolled * 1)) + 'px');
